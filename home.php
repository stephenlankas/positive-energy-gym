...
<html>
<head>
	<title>Positive Energy Gym</title>
	<meta charset="utf-8">
...
<body style="background:url(gym1.jpg);">
  ...
  <a class="navbar-brand" href="home.php">positive Energy Gym</a>
  <a href="logout.php" class=" nav nav-link">sign out</a>
</div>
</nav>
  ...
  <div class="col-2">
    ...
    <div class="list-group">
      ...
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
          <div class="list-group-item" style="background-color: #add8e6;"><a href="home.php?info=add_gym" class="text-light">ADD GYM</a>
          </div>
          <div class="list-group-item" style="background-color: #add8e6;"><a href="home.php?info=manage_gym" class="text-light">VIEW GYMS</a></div>
        </div>
      <div class="list-group-item bg-dark">
      ...
      <div id="collapseThree" class="collapse" data-parent="#accordion">
        <div class="list-group-item" style="background-color: #add8e6;">
      ...
      <div id="collapsefive" class="collapse" data-parent="#accordion">
          <div class="list-group-item" style="background-color: #add8e6;"><a href="home.php?info=add_member" class="text-light">ADD MEMBER</a></div>
          <div class="list-group-item" style="background-color: #add8e6;"><a href="home.php?info=manage_member" class="text-light">VIEW MEMBERS</a></div>
        </div>
         <div class="list-group-item bg-dark">
      ...
      <div id="collapsesix" class="collapse" data-parent="#accordion">
          <div class="list-group-item" style="background-color: #add8e6;"><a href="home.php?info=add_trainer" class="text-light">ADD TRAINER</a></div>
          <div class="list-group-item" style="background-color: #add8e6;"><a href="home.php?info=manage_trainer" class="text-light">VIEW TRAINERS</a></div>
        </div>
    </div>
</div>
  </div>
